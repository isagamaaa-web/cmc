...
export const translations = {
  en: {
    ...
    transparentPricingDesc: "Clear quotes upfront. No surprises after treatment.",
    ...
    transparentPricingServices: "Comprehensive laboratory testing and specialist clinical care — processed in-house, delivered without the runaround. Every price below is transparent and quoted in Ethiopian Birr (ETB).",
    ...
    chatOffline: "You appear to be offline. I can still answer questions about our prices, services, opening hours and location — just ask. For anything else, call 0912-22-49-71.",
    chatError: "I couldn't reach our assistant just now. I can still help with prices, services, hours and our location — or call 0912-22-49-71 / 0911-48-72-49.",
