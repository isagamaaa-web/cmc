...
const CSP = [
  "default-src 'self'",
  // TanStack SSR/hydration injects inline bootstrap scripts; Google Translate is loaded on demand.
  ...
  "connect-src 'self' https://translate.googleapis.com https://fonts.gstatic.com",
